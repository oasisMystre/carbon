...
pub struct TwoHopSwapInstructionAccounts {
    ...
    pub tick_array_one_0: solana_pubkey::Pubkey,
    pub tick_array_one_1: solana_pubkey::Pubkey,
    pub tick_array_one_2: solana_pubkey::Pubkey,
    pub tick_array_two_0: solana_pubkey::Pubkey,
    pub tick_array_two_1: solana_pubkey::Pubkey,
    pub tick_array_two_2: solana_pubkey::Pubkey,
...
impl carbon_core::deserialize::ArrangeAccounts for TwoHopSwap {
    ...
    fn arrange_accounts(
        ...
        let tick_array_one_0 = next_account(&mut iter)?;
        let tick_array_one_1 = next_account(&mut iter)?;
        let tick_array_one_2 = next_account(&mut iter)?;
        let tick_array_two_0 = next_account(&mut iter)?;
        let tick_array_two_1 = next_account(&mut iter)?;
        let tick_array_two_2 = next_account(&mut iter)?;
